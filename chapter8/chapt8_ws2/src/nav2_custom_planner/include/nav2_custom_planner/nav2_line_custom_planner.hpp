#ifndef NAV2_LINE_CUSTOM_PLANNER__NAV2_LINE_CUSTOM_PLANNER_HPP_
#define NAV2_LINE_CUSTOM_PLANNER__NAV2_LINE_CUSTOM_PLANNER_HPP_
...
namespace nav2_line_custom_planner {
  // 自定义导航规划器类
  class LineCustomPlanner : public nav2_core::GlobalPlanner {
    public:
      LineCustomPlanner() = default;
      ~LineCustomPlanner() = default;
      // 纯虚函数需要全部（五个）在类中重写
      // 插件配置方法
      void configure(

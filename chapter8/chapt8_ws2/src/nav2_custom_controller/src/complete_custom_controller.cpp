#include "nav2_custom_controller/complete_custom_controller.hpp"
...
namespace nav2_complete_custom_controller {
        ...
        const geometry_msgs::msg::Twist &, nav2_core::GoalChecker *)
    {
        ...
        RCLCPP_INFO(node_->get_logger(), "控制器：%s 发送速度(x: %f,z: %f)", plugin_name_.c_str(), cmd_vel.twist.linear.x, cmd_vel.twist.angular.z);
...
PLUGINLIB_EXPORT_CLASS(nav2_complete_custom_controller::CustomController, nav2_core::Controller)

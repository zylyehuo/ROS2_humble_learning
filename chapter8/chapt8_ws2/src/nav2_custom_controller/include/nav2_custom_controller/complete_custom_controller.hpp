#ifndef NAV2_COMPLETE_CUSTOM_CONTROLLER__NAV2_COMPLETE_CUSTOM_CONTROLLER_HPP_
#define NAV2_COMPLETE_CUSTOM_CONTROLLER__NAV2_COMPLETE_CUSTOM_CONTROLLER_HPP_

#include <memory>
#include <string>
#include <vector>

#include "nav2_core/controller.hpp"  // 抽象类所在头文件,并且包含了 #include "rclcpp/rclcpp.hpp"
#include "nav2_util/robot_utils.hpp"  // 机器人的工具函数


namespace nav2_complete_custom_controller {
...
#endif // NAV2_COMPLETE_CUSTOM_CONTROLLER__NAV2_COMPLETE_CUSTOM_CONTROLLER_HPP_

...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name+"/launch", glob('launch/*.launch.py')),  # 安装 launch 文件
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            "face_detect_client_callback_node = demo_python_service.face_detect_client_callback_node:main",
        ],
    },
)
